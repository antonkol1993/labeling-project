...
public class ImageHandlerMain {
    ...
    public static void addImageToSheet(Workbook workbook, Sheet sheet, String imagePath,
        ...
        double scaleX = (cellWidthPx * 0.80) / originalWidth;  // 85% от ширины ячейки
        double scaleY = (cellHeightPx * 0.80) / originalHeight;  // 85% от высоты ячейки
...
// Конвертируем в EMU для правильного позиционирования
        if (workbook instanceof XSSFWorkbook) {
            ...
            picture.getPreferredSize(scale,scale);  // Применяем масштаб
        }
